...
function VideoCard({displayData,setDeleteVideoResponse,insideCategory}) {
  ...
  return ( 
    <>
    <Card draggable onDragStart={(e)=>dragStarted(e,displayData?.id)} className='shadow' style={{width:'210px', height:'300px'}}>
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="400" src={`${displayData?.youtubeLink}?autoplay=1`} title=""  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
